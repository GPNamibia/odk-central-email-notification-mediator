...
const { ebs_verfication } = require('../models');
const privateConfig = require('../config/private-config.json');


//Retrieve submissions from MySQL and convert to CSV
async function retrieveRecordsFromMysql(model, table_name) {
            ...
            .then(async(res) => {
                res.forEach(async(value) => {
                    if (value.vbe_triage_result == "Passed") {
                        ...
                        console.log("Record failed for verification", value.email_status)
                    }
                })
                                            ...
                                            <tr>
                                              <td align="left">
                                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                  <tbody>
                                                    <tr>
                                                      <td> <a href="https://www/" target="_blank">Open ODK form 4 to complete Risk Assesment</a> </td>
                                                    </tr>
                                                  </tbody>
                                                </table>
                                              </td>
                              ...
                              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                  <td class="content-block powered-by">
                                    Powered by <a href="https://www.ucsf.edu/">UCSF</a>.
                                  </td>
                                </tr>
                              </table>
                            </div>
